...
(function(root) {
    ...
    init = function(config) {
        ...
        //  index.html (Karma doesn't play nice with html files, it insists
        //  on using html imports which don't really work cross-browser if
        //  you're also using iframes...which we are.
        files.unshift({
            pattern: loader,
            served: true, included: true, watched: false, nocache: true
        });
